...
const GROUPS = [
  {
    ...
    items: [
      { href: "/bots/ad-campaign", title: "بوت الحملات الإعلانية", desc: "نقاط وإعلانات وروابط إيداع/سحب." },
      { href: "/bots/store", title: "بوت المتجر", desc: "منتجات وطلبات." },
      { href: "/bots/clinic", title: "بوت العيادة", desc: "حجز مواعيد." },
    ],
  },
];
