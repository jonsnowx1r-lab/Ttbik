...
export const BOT_TEMPLATES: BotTemplate[] = [
  {
    ...
    tagline: "نقاط + إعلانات + محفظة مربوطة بالموقع",
    desc: "بوت عامل لجمهورك: مشاهدة حملات، رصيد نقاط، إحالات، ومسابقات. روابط الإيداع والسحب تُولَّد من موقعك وليست محفظة وهمية داخل البوت.",
    icon: "📢",
    ...
    defaults: {
      welcome:
        "أهلاً بك. هذا بوت الحملات الرسمي.\nشاهد الإعلانات المعتمدة، اجمع النقاط، واطلب إيداعاً أو سحباً عبر رابط يصدر من الموقع.",
      currencyName: "نقطة",
      faq: "النقاط رصيد داخلي لهذه القناة فقط.\nالإيداع والسحب يتمان عبر صفحة دفع على موقع سوق تولز بعد توليد رابط خاص بك.\nلا يوجد وعد بأرباح أو عملة رقمية تلقائية.",
      extra: {
