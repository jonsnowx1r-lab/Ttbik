...
export const BOT_TEMPLATES: BotTemplate[] = [
  {
    ...
    tagline: "إعلانات حقيقية + حضور يومي + متصدرون + إحالات مكافأة",
    desc: "بوت عامل لجمهورك: مشاهدة حملات إعلانية حقيقية بمكافأة فورية، حضور يومي، لوحة متصدرين، وإحالات تُكافئ فعلياً عند انضمام صديق. الإيداع عبر رابط من موقعك — لا يوجد سحب نقدي، النقاط داخل البوت فقط.",
    icon: "📢",
