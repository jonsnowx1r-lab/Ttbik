...
export const BOT_TEMPLATES: BotTemplate[] = [
  {
    ...
    tagline: "نقاط + إعلانات + رصيد مسبق الدفع فقط",
    desc: "بوت عامل لجمهورك: مشاهدة حملات، رصيد نقاط، إحالات، ومسابقات. الإيداع فقط عبر رابط من موقعك — لا سحب نقدي على الإطلاق.",
    icon: "📢",
